...
class RGBPredictionModel(nn.Module):
    ...
    def __init__(self, text_embed_dim, poly_feature_dim=10, hidden_dims=[256, 128], 
        ...
        logging.debug(f"Model input dimensions: parent={text_embed_dim}, polygon={self.poly_feature_processed_dim}, child={text_embed_dim}")
        logging.debug(f"Network path output dimensions: parent={parent_dim}, polygon={poly_dim}, child={child_dim}, total={parent_dim+poly_dim+child_dim}")
